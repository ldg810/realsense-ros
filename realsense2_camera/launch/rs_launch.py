...
configurable_parameters = [{'name': 'camera_name',                  'default': 'camera', 'description': 'camera unique name'},
                           ...
                           {'name': 'depth_width',                  'default': '480', 'description': 'depth image width'},                           
                           {'name': 'depth_height',                 'default': '270', 'description': 'depth image height'},                           
                           ...
                           {'name': 'confidence_width',             'default': '480', 'description': 'depth image width'},                           
                           {'name': 'confidence_height',            'default': '270', 'description': 'depth image height'},                           
